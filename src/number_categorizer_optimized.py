...
def categorize_number_optimized(number_str: str, context: str) -> str:
    """Convenience function for categorizing a single number."""
    return get_optimized_categorizer().categorize(number_str, context)
